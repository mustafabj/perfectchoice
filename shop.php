        ...
        <div class="bestBox">
            ...
            while ($product  = mysqli_fetch_assoc($result)) {
                ...
                echo "  <a href='product.php?id={$product['proId']}'>
                    <div class='probox'>
                        <div class='img' style='background-image: url(image/{$product['proPhoto']})' loading='lazy'></div>
                        <div class='text'>
        ...
        <div class="pagination">
            ...
            if (isset($_GET['page']) && $_GET['page'] > 1) {
                if (isset($_GET['brandId'])) {
                    echo "<a href='shop.php?brandId={$_GET['brandId']}&page=" . ($_GET['page'] - 1) . "'>&laquo;</a>";
                } elseif (isset($_GET['catId'])) {
                    echo "<a href='shop.php?catId={$_GET['catId']}&page=" . ($_GET['page'] - 1) . "'>&laquo;</a>";
                } else {
                    echo "<a href='shop.php?page=" . ($_GET['page'] - 1) . "'>&laquo;</a>";
                }
            } else {
            ...
            for ($i = 1; $i <= $total_page; $i++) {
                if (isset($_GET['brandId'])) {
                    if (isset($_GET['page']) && $i == $_GET['page']) {
                        echo " <a class='active' href='shop.php?brandId={$_GET['brandId']}&page={$i}'>$i</a>";
                    } elseif (!isset($_GET['page']) && $i == 1) {
                        echo " <a class='active' href='shop.php?brandId={$_GET['brandId']}&page={$i}'>$i</a>";
                    } else {
                        echo " <a href='shop.php?brandId={$_GET['brandId']}&page={$i}'>$i</a>";
                    }
                } elseif (isset($_GET['catId'])) {
                    if (isset($_GET['page']) && $i == $_GET['page']) {
                        echo " <a class='active' href='shop.php?catId={$_GET['catId']}&page={$i}'>$i</a>";
                    } elseif (!isset($_GET['page']) && $i == 1) {
                        echo " <a class='active' href='shop.php?catId={$_GET['catId']}&page={$i}'>$i</a>";
                    } else {
                        echo " <a href='shop.php?catId={$_GET['catId']}&page={$i}'>$i</a>";
                    }
                } else {
                    if (isset($_GET['page']) && $i == $_GET['page']) {
                        echo " <a class='active' href='shop.php?page={$i}'>$i</a>";
                    } elseif (!isset($_GET['page']) && $i == 1) {
                        echo " <a class='active' href='shop.php?page={$i}'>$i</a>";
                    } else {
            ...
            if (isset($_GET['page']) && $_GET['page'] < $total_page) {
                if (isset($_GET['brandId'])) {
                    echo "<a href='shop.php?brandId={$_GET['brandId']}&page=" . ($_GET['page'] + 1) . "'>&raquo;</a>";
                } elseif (isset($_GET['catId'])) {
                    echo "<a href='shop.php?catId={$_GET['catId']}&page=" . ($_GET['page'] + 1) . "'>&raquo;</a>";
                } else {
                    echo "<a href='shop.php?page=" . ($_GET['page'] + 1) . "'>&raquo;</a>";
                }
            } elseif ($total_page > 1) {
                if (isset($_GET['page']) && $_GET['page'] < $total_page) {
                    if (isset($_GET['brandId'])) {
                        echo "<a href='shop.php?brandId={$_GET['brandId']}&page=2'>&raquo;</a>";
                    } elseif (isset($_GET['catId'])) {
                        echo "<a href='shop.php?catId={$_GET['catId']}&page=2'>&raquo;</a>";
                    } else {
                        echo "<a href='shop.php?page=2'>&raquo;</a>";
                    }
                } else {
